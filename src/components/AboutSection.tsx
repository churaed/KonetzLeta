        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center space-y-8">
            <div className="space-y-4">
              <h2 className="text-6xl md:text-8xl font-cormorant italic text-white leading-tight">
                {t('about.title_part1')} <span className="text-red-400">{t('about.title_part2')}</span>
              </h2>
              <motion.div
          ...
          >
            ...
            >
              ...
              <div className="space-y-3">
                <h3 className="text-2xl font-cormorant italic text-white">{t('about.innovation.title')}</h3>
            ...
            >
              ...
              <div className="space-y-3">
                <h3 className="text-2xl font-cormorant italic text-white">{t('about.technology.title')}</h3>
                <p className="text-gray-400 font-mono text-sm leading-relaxed">
            ...
            >
              ...
              <div className="space-y-3">
                <h3 className="text-2xl font-cormorant italic text-white">{t('about.soul.title')}</h3>
                <p className="text-gray-400 font-mono text-sm leading-relaxed">
                  {t('about.soul.description')}
                </p>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="max-w-2xl mx-auto p-8 border border-red-400/20 rounded-lg bg-black/30 backdrop-blur-sm">
              <div className="space-y-4 text-xl md:text-2xl font-cormorant italic text-gray-300 leading-relaxed">
                <p>{t('about.haiku.line1')}</p>
                <p className="text-red-400">{t('about.haiku.line2')}</p>
                <p>{t('about.haiku.line3')}</p>
              </div>
              <motion.div
          ...
          >
            {[
              ...
              { number: "1", label: t('about.stats.passion') },
            ].map((stat, index) => (
              <motion.div
                key={index}
                className="space-y-2"
